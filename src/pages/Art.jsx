...
const Art = () => {
  ...
  // Veritabanından (locales.js) 'huner' kısmını çekiyoruz
  // Veri yoksa hata vermemesi için boş obje {} kontrolü
  const content = siteContent[lang]?.pages?.huner || { 
    title: "Huner", 
    desc: "Loading...", 
    sections: [] 
  };
          ...
          >
            ...
            <div className="bg-teal-600 p-8 md:p-12 text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-teal-100 text-lg md:text-xl font-medium max-w-2xl">{content.desc}</p>
              </div>
